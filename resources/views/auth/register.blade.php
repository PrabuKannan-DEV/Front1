                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <input name='phone_number' type="number" class="form-control col" id="phone_number"
                        ...
                        <div class="row ">
                            ...
                            <div class="col-md-6">
                            <input name='address'placeholder="Enter address" type="text" class="form-control col" id="address"
